...
export default class CircularSlider extends React.Component<IProps, any> {
  static defaultProps = {
    radius: 100,
    strokeWidth: 20,
  ...
  _containerRef = React.createRef<any>();
  ...
  _handlePanResponderMove = (e: GestureResponderEvent, gestureState: any) => {
    ...
    this.setState(({ value: curValue }: { value: number }) => {
  ...
  _handlePanResponderEnd = (e: GestureResponderEvent, gestureState: any) => {
